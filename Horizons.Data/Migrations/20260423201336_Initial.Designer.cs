...
namespace Horizons.Data.Migrations
{
    ...
    [Migration("20260423201336_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Horizons.Data.Entities.Destination", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Rila Monastery",
                            PublishedOn = new DateTime(2026, 4, 23, 23, 13, 36, 21, DateTimeKind.Local).AddTicks(5905),
                        ...
                        new
                        {
                            ...
                            PublishedOn = new DateTime(2026, 4, 23, 23, 13, 36, 21, DateTimeKind.Local).AddTicks(5954),
                            PublisherId = "7699db7d-964f-4782-8209-d76562e0fece",
                            TerrainId = 2
                        },
                        new
                        {
                            ...
                            PublishedOn = new DateTime(2026, 4, 23, 23, 13, 36, 21, DateTimeKind.Local).AddTicks(5956),
                            PublisherId = "7699db7d-964f-4782-8209-d76562e0fece",
                            TerrainId = 7
                        });
                });

            modelBuilder.Entity("Horizons.Data.Entities.Terrain", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Horizons.Data.Entities.UserDestination", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1c2d3da1-fa45-4f46-ad2d-37d8e7a5b5f5",
                            Email = "admin@horizons.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@HORIZONS.COM",
                            NormalizedUserName = "ADMIN@HORIZONS.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEAWYRwR4fcobWZvfw1B5rdWAvFf4VfGtaCYmJDestnKJ0ZoiJpARtsdG350H70Cs4Q==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "4c774027-23cd-4169-92ae-f1fed5a6ddd9",
            ...
            modelBuilder.Entity("Horizons.Data.Entities.Destination", b =>
                {
                    ...
                    b.HasOne("Horizons.Data.Entities.Terrain", "Terrain")
            ...
            modelBuilder.Entity("Horizons.Data.Entities.UserDestination", b =>
                {
                    b.HasOne("Horizons.Data.Entities.Destination", "Destination")
